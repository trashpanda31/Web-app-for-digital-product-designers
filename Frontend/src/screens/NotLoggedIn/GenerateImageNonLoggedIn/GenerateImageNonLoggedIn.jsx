...
export const GenerateImageNonLoggedIn = () => {
  return (
    <div className="bg-[#f7faff] min-h-screen flex flex-row justify-center w-full">
      <div className="bg-[#f7faff] w-[1440px] h-[720px] relative">
        ...
        <section className="content">
          <p className="absolute w-[533px] top-[180px] left-[453px] [font-family:'Gilroy-SemiBold',Helvetica] font-normal text-black text-5xl text-center tracking-[0] leading-[normal]">
            Hello! I'm your AI-image generator!
          </p>
          <p className="absolute w-[528px] top-[325px] left-[456px] [font-family:'Gilroy-Regular',Helvetica] font-normal text-black text-2xl text-center tracking-[0] leading-[normal]">
